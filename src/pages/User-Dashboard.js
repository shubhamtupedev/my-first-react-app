            ...
            <div className="unlimited-access hide-menu bg-light-primary position-relative mb-7 mt-5 rounded">
              <div className="d-flex">
                <div className="unlimited-access-title me-3">
                  ...
                  <a href="https://adminmart.com/product/modernize-bootstrap-5-admin-template/" rel="noopener noreferrer" target="_blank" className="btn btn-primary fs-2 fw-semibold lh-sm">Buy Pro</a>
                </div>
      ...
      <div className="body-wrapper">
          ...
          <nav className="navbar navbar-expand-lg navbar-light">
            ...
            <div className="navbar-collapse justify-content-end px-0" id="navbarNav">
              <ul className="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                <a href="https://adminmart.com/product/modernize-free-bootstrap-admin-dashboard/" target="_blank" rel="noopener noreferrer" className="btn btn-primary">Download Free</a>
        ...
        <div className="container-fluid">
          ...
          <div className="py-6 px-6 text-center">
            <p className="mb-0 fs-4">Design and Developed by <a href="https://adminmart.com/" target="_blank" rel="noopener noreferrer" className="pe-1 text-primary text-decoration-underline">AdminMart.com</a> Distributed by <a href="https://themewagon.com">ThemeWagon</a></p>
          </div>
        </div>
      </div>
    </div>
